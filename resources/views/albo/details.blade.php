                    ...
                    <div class="col-6">
                        ...
                        <ul class="multi-row">
                            @foreach ($albo->storie AS $storia)
                                <li><a data-target="#tramaModal" class="modale-trama" data-toggle="modal" data-id-storia="{{ $storia->id }}" href="#tramaModal"> {{ $storia->nome }} </a>
                                <a href="{{ route('storia.details', $storia) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
